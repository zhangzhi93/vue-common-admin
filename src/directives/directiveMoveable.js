    ...
    app.directive('moveable', {
      mounted(el, binding) {
        ...
        op.onmousedown = function (e) {
          ...
          const Width = op.parentNode.tagName === 'BODY' ? document.documentElement.clientWidth : op.parentNode.offsetWidth;
          const Height = op.parentNode.tagName === 'BODY' ? document.documentElement.clientHeight : op.parentNode.offsetHeight;
          // 鼠标按下，计算当前元素距离可视区的距离
